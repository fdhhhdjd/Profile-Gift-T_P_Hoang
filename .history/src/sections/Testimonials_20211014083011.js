        ...
        <div className="container">
          ...
          <div className="testimonials">
            <Testimonial
              ...
              Sự phát triển."
              name="Khách hàng"
              designation="Thái Huỳnh"
              variants={cardAnimation}
              animate={controls}
            />
            <Testimonial
              content="Nhà phát triển ứng dụng di động chính xác là những gì doanh nghiệp đang mắc phải. Tôi đã nhận được ít nhất 50 lần giá trị từ chức năng ký tự trên thiết bị di động."
              name="Kishan H. Sheth"
