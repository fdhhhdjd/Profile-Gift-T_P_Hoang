      ...
      <div className="testimonials-container" id="testimonial" ref={element}>
        <div className="container">
          ...
          <div className="testimonials">
            <Testimonial
              content="Nhờ có bạn mà công ty đã có một sức mạnh để chiến đấu với các công ty nước ngoài,cảm ơn bạn,mong bạn sẽ còn hợp tác và phát triền với công ty chúng tôi."
              name="Thái Huỳnh"
