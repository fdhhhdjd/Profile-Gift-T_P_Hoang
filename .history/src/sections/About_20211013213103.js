    ...
    <>
      <div className="about-container" id="about" ref={element}>
        <div className="container">
          ...
          >
            <Title title="About HOANGPC" color="blue" />
            <p>
              Chúng tôi tin rằng mọi người đều xứng đáng có một trang web hoặc
              trực tuyến cửa hàng. Đổi mới và đơn giản làm cho chúng tôi hạnh
